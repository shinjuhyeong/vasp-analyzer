...
export function EnergyModule(props: EnergyModuleProps): ReactElement {
  ...
  return <><Controls {...props} />{props.mode === "graph" ?
    ...
    <div className="detail-table-scroll"><table className="detail-table" aria-label="Energy terms"><caption>Energy terms for ionic step {props.selectedIndex + 1} (eV)</caption><thead><tr><th>Key</th><th>OUTCAR label</th><th>Kind</th><th>Value</th><th>Rank</th></tr></thead><tbody>
